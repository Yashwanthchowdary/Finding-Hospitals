...
public class Base {
	...
	public void invokeBrowser() {
		...
		try {
			prop.load(new FileInputStream("/Users/mandajayaprakash/Desktop/FindingHospitals 2/src/main/java/config/config.properties"));
		} catch (Exception e) {
			e.printStackTrace();
		}

		// To Open Chrome Browser
		if (prop.getProperty("browserName").matches("safari")) {
			System.setProperty("webdriver.safari.driver",
					System.getProperty("user.dir") + "usr/bin/safaridriver");
